...
export function removeRow(courseId) {
  return request({
    url: `/graduatePerf/matrix/row/${courseId}`,
    method: 'delete'
  })
}
...
export function removeCol(abilityId) {
  return request({
    url: '/graduatePerf/matrix/col/${abilityId}',
    method: 'delete'
  })
}
