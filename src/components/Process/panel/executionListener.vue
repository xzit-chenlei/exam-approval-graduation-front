<template>
  <div class="panel-tab__content">
    ...
    <div class="element-drawer__button_save">
      <el-button type="primary" icon="el-icon-plus" size="small" @click="openSystemListener">内置监听器</el-button>
    ...
    <el-drawer :visible.sync="listenerSystemVisible" title="执行监听器" size="580px" append-to-body destroy-on-close>
      <el-table v-loading="loading" :data="listenerList" @selection-change="handleSelectionChange" ref="systemListenerTableRef">
...
export default {
  ...
  methods: {
    ...
    openSystemListener() {
      this.listenerSystemVisible = true;

      // TODO: 选中已经配置的监听器

      // this.checkedListenerData = this.elementListenersList;
      //
      // this.$nextTick(() => {
      //   this.checkedListenerData.forEach((item, index) => {
      //     this.$refs.systemListenerTableRef.toggleRowSelection(item);
      //   });
      // });
    },
    ...
    handleSelectionChange(selection) {
      ...
      this.listenerSystemChecked = selection.length <= 0;
    },
